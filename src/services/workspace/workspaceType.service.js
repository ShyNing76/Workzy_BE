...
export const createWorkspaceTypeService = async (data) => new Promise(async (resolve, reject) => {
    try {
...
export const getWorkspaceTypeService = async ({id}) => new Promise(async (resolve, reject) => {
    try {
...
export const updateWorkspaceTypeService = async ({id}, data) => new Promise(async (resolve, reject) => {
    try {
        const checkDuplicateName = await isDuplicate(db.WorkspaceType, "workspace_type_name", data.workspace_type_name);
        if (checkDuplicateName) {
            return reject("Workspace type name already exists");
